...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h2>Programmeuse analyste <span> Freelance. </span></h2>
  ...
  <section id="about" class="about">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <p class="text-justify;">
            Infirmière dévouée pendant 10 ans, je suis maintenant programmeuse analyste Junior "Full-stack".
          </p>
          <p class="text-justify;">
            Je suis passionnée par la création de sites web et d'applications en ligne et je suis très intéressée par
            l'opportunité de travailler avec vous et de contribuer à votre succès.
          </p>
          <p style="font-style: italic;">
            Ma motivation et ma détermination seront mes atouts principaux pour atteindre vos objects et combler vos besoins.
          </p>
    ...
    <!-- TODO: Ajouter à une BD projet table Commentaire et créer testimoniale item avec DHTML -->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Jessika Soucy</h4>
            <p><em> Programmeuse Analyste Junior
                Infirmière dévouée pendant 10 ans, je suis maintenant programmeuse analyste passionnée et créative avec un excellent esprit d'équipe . De par mes expériences antérieures, je possède aussi un fort sens de l'analyse et le souci du détail .</em></p>
            <p>
              <!-- <ul>
              <li>Sorel-Tracy, Québec, Canada</li>
              <li>(450)-881-5151</li>
              <li>jessikasoucy@outlook.com</li>
            </ul> -->
            </p>
          </div>
          ...
          <div class="resume-item">
            ...
            <p><em>CÉGEP Sorel-Tracy, Sorel-Tracy, QC, CA </em></p>
            <p>
            <ul>
              <li>S'adapter à différente situations de travail</li>
      ...
      <div class="row mt-5">
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
          <div class="icon-box">
            ...
            <h4>BOUTIQUE EN LIGNE</a></h4>
            <p style="text-align: left;">
              Les boutiques en ligne sont des sites web dits transactionnels pour les entreprises qui souhaitent vendre des produits en ligne.
              Elles permettent aux clients de parcourir les produits, de les ajouter à leur panier,
              de passer des commandes et de finaliser les paiements en ligne de manière sécurisée en tout temps .
              Une application web qui prend la forme d’un magasin est considérée comme du e-commerce .
            </p>
            <div class="row">
              <div class="col-lg-12">
                <ul class="mt-3">
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
          <div class="icon-box">
            ...
            <h4>INSTALLATION DE PÉRIPHÉRIQUE</a></h4>
            <p style="text-align: left;">
              " Je suis en mesure de vous aider à installer des périphériques tels que des imprimantes, des scanners, des caméras
              et bien plus encore . "
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
          <div class="icon-box">
            ...
            <h4>SUPPORT TECHNIQUE</a></h4>
            <p style="text-align: left;">
              " Je propose des services de mises à jour de sécurité régulières, de sauvegarde, de support en cas de problème technique et ce,
              à distance ou à domicile selon vos besoins . "
            </p>
          </div>
        </div>
